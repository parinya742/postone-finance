...
class DomesticLetterRateController extends Controller
{
    ...
    {
        return DB::connection('n8n')->table('domestic_letter_rates')->whereNull('deleted_at');
    }
    ...
    public function store(Request $request): JsonResponse
    {
        ...
        $id = DB::connection('n8n')->table('domestic_letter_rates')->insertGetId($data);
    ...
    public function destroy(int $id): JsonResponse
    {
        ...
        DB::connection('n8n')->table('domestic_letter_rates')->where('id', $id)->update([
            'deleted_at' => now(),
            'deleted_by' => auth()->id(),
        ]);
